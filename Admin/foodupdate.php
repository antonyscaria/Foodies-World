    ...
    <div id="view">
      <div class="grid-container">
            ...
            {?>
                ...
                <div class="grid-item"><button type="button"  name ="edit" value="edit" class="registerbtn"onclick="location.href='foodupdate2.php?uid=<?php echo $row['id']?>;'">Edit</button></div>    
           <?php $x=$x+1;}
            ?>
          </div>
        </div>
